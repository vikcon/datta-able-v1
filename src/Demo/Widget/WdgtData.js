                            ...
                            <Card.Body>
                                ...
                                <div className="row m-t-35">
                                    <div className="col-6 p-r-0">
                                        <a href={DEMO.BLANK_LINK} className="btn btn-primary text-uppercase btn-block">add friend</a>
                                    </div>
                                    <div className="col-6">
                                        <a href={DEMO.BLANK_LINK} className="btn text-uppercase border btn-block btn-outline-secondary p-15">message</a>
                                    </div>
                                </div>
                            </Card.Body>
                        </Card>
                    ...
                    <Col md={6} xl={4}>
                        <Card className='note-bar'>
                            ...
                            <Card.Body className='p-0'>
                                <a href={DEMO.BLANK_LINK} className="media friendlist-box">
                                    <div className="mr-3 photo-table">
                                ...
                                <a href={DEMO.BLANK_LINK} className="media friendlist-box border-top">
                                    <div className="mr-3 photo-table">
                                        <i className="fa fa-bell f-30"/>
                                    </div>
                                    <div className="media-body">
